...
public class Reports extends AppCompatActivity {
    private final AppCompatActivity activity = Reports.this;
    private ConstraintLayout layout;
    private Button btnLevel, btnCarrer, btnDate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLevel = findViewById(R.id.btnReportLevel);
        btnCarrer = findViewById(R.id.btnReportCarrer);
        btnDate = findViewById(R.id.btnReportDate);
        layout = findViewById(R.id.reportsLayout);
        ...
        btnCarrer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (isStoragePermissionGranted()) {
                    savePdfCarrer();
        ...
        btnDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), ReportDate.class);
                startActivity(i);
            }
        });
    ...
    private void savePdfLevel() {
        ...
        try{
            ...
            if (report.size() < 0){
                ...
                mDoc.add(new Paragraph("Servicios por nivel\n\n",f));
...
//            Snackbar.make(layout,mFileName+".pdf\nse guardó en\n"+pdfFolder.getAbsolutePath(),Snackbar.LENGTH_LONG).show();
    ...
    private void savePdfCarrer() {
        ...
        try{
            ...
            if (report.size() < 0){
                ...
                mDoc.addAuthor("ASO");
                Font f = new Font(Font.FontFamily.TIMES_ROMAN,30.0f,Font.BOLD,BaseColor.BLACK);
                mDoc.add(new Paragraph("Servicios por carrera\n\n",f));
